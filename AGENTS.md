...
- City selection should use the compact custom autocomplete instead of native `datalist`, keeping suggestion rows to city names only and preserving manual fallback.
